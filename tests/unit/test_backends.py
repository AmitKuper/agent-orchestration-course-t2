"""Unit tests for src/backends.py — ApiBackend, CliBackend, make_backend."""
...
from src.backends import ApiBackend, CliBackend, make_backend
...
def test_api_backend_records_tokens(cost: CostTracker):
    ...
    with patch("src.backends.anthropic.Anthropic") as mock_anthropic:
        backend = ApiBackend()
